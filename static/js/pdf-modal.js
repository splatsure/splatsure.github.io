    ...
    <div class="pdf-toolbar">
      <div class="pdf-toolbar-left">
        <a href="#" onclick="closePDF(event)" class="pdf-logo-close" aria-label="Close">
          <img src="./static/images/favicon.svg" alt="SplatSuRE" class="logo-desktop" style="height:22px;width:auto;">
          <img src="./static/images/favicon.svg" alt="SplatSuRE" class="logo-mobile" style="height:26px;width:auto;">
        </a>
